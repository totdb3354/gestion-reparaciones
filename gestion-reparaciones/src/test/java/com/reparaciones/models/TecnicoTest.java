...
class TecnicoTest {
    ...
    void getIdTec_devuelveValorCorrecto() {
        assertEquals(3, new Tecnico(3, "Daniel García").getIdTec());
    }

    @Test
    void getNombre_devuelveValorCorrecto() {
        assertEquals("Daniel García", new Tecnico(3, "Daniel García").getNombre());
    }

    @Test
    void setIdTec_actualizaCorrectamente() {
        Tecnico t = new Tecnico(1, "Daniel García");
        t.setIdTec(5);
    ...
    void toString_devuelveNombre() {
        assertEquals("Daniel García", new Tecnico(1, "Daniel García").toString());
    }
}
